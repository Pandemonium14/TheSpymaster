...
public abstract class AbstractEasyPower extends AbstractPower {
    ...
    public AbstractEasyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TexLoader.getTexture(SpyMod.modID + "Resources/images/powers/" + ID.replaceAll(SpyMod.modID + ":", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(SpyMod.modID + "Resources/images/powers/" + ID.replaceAll(SpyMod.modID + ":", "") + "84.png");
        if (hiDefImage != null) {
